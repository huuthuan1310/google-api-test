...
var FolderComponent = /** @class */ (function () {
    ...
    FolderComponent.prototype.log = function () {
        console.log('log');
    };
...
var authRoutes = [{ path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] }];
...
var AuthService = /** @class */ (function () {
    function AuthService(googleAuthService, router, ngZone) {
    ...
    AuthService.prototype.signIn = function () {
        ...
        this.googleAuthService.getAuth().subscribe(function (auth) {
            auth
                .signIn()
                .then(function (res) { return _this.signInSuccessHandler(res); }, function (err) { return _this.signInErrorHandler(err); });
        });
    };
            ...
            try {
                auth.signOut().then(function (res) {
                    _this.ngZone.run(function () {
                        sessionStorage.removeItem(_this.SESSION_STORAGE_KEY);
    ...
    AuthService.prototype.signInSuccessHandler = function (res) {
        var _this = this;
        this.ngZone.run(function () {
            _this.user = res;
            sessionStorage.setItem(_this.SESSION_STORAGE_KEY, res.getAuthResponse().access_token);
            _this.router.navigateByUrl('');
        });
    };
    AuthService.prototype.signInErrorHandler = function (err) {
        console.warn(err);
    };
    ...
    AuthService.prototype.getToken = function () {
        var token = sessionStorage.getItem(this.SESSION_STORAGE_KEY);
        if (!token) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, authService, driveResource) {
        this.router = router;
        this.authService = authService;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.driveResource.getList(this.authService.getToken()).subscribe(function (res) {
            _this.folders = res.files.map(function (x) {
            ...
            if (err.status === 401) {
                ...
                sessionStorage.setItem('redirectUrl', _this.router.url);
            }
        });
    };
...
var LayoutRoutingMoule = /** @class */ (function () {
    function LayoutRoutingMoule() {
    }
...
var DriveResource = /** @class */ (function () {
    function DriveResource(httpClient) {
    ...
    DriveResource.prototype.getList = function (authtoken) {
    ...
    DriveResource.prototype.getById = function (id, authtoken) {
    ...
    DriveResource.ctorParameters = function () { return [
